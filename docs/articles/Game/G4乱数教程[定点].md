...
![pokefinder](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/Pokefinder.png)
...
![G4_static](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/G4_static.png)

选择完条件后点【检索】，等几秒，底下就会出结果：

![G4_static2](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/G4_static2.png)
...
![select_seed](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/select_seed.png)
...
:::
![seed_time](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/seed_time.png)
...
![Eontimer](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/Eontimer.png)
...
![heatran](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/heatran.jpg)

进入机器的时间设置，把日期设置为上面所选时间（2011-10-24），然后去小时分钟设置，设置为上面所选时间（15:59，另外EonTimer左上角的Minutes Before Target是0，所以这里直接设置15:59即可，如果是1那就15:58，如果是2就15:57，以此类推），*先别按A确定！！！！！！*。

![time](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/time.png)
...
![home](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/home.jpeg)
3. 在第二次倒计时结束前到读取存档界面等待（我选的844这个Delay第二次倒计时只有18:503，可以说非常极限了，新手一定要选个大一点的Delay），6声滴响起瞬间按A进入游戏
![loading](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/loading.jpeg)
...
![search_flips](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/search_flips.png)
...
:::
![search_flips2](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/search_flips2.png)
...
![heatran2](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/heatran2.jpg)

![heatran1](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/heatran1.jpeg)
...
![ivcalculator](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/ivcalculator.png)

上面点击【Find IVs】后，Gen 4 Static这个窗口右侧过滤器应该也会自动输入上面检索结果，如果没的话请手动输入一下，别忘了把Shiny改回“任何”，性格也要手动选一下，然后点检索：
![ivsearch](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/ivsearch.png)
...
![irwin](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/irwin.jpg)
![irwin2](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/irwin2.jpg)

然后在每次倒计时结束进入游戏后，给他打电话，第一句话会有以下3种情况，分别记为K、E、P：

![KEP](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/KEP.png)

然后和查硬币一样，连续打电话，记录内容，只不过【Search flips】变成了【Search calls】：

![search_calls](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/search_calls.png)
...
![map](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/map.png)
...
![calibrate](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/calibrate.png)
...
![search_flips3](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/search_flips3.png)

进入战斗，闪光！（席多蓝恩闪光是紫色眼睛，拍屏原因可能不是很明显）
![shine](/Users/ggxxding/Documents/GitHub/ggxxding/docs/src/images/G4_stationary/shine.png)
